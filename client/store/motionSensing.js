export function checkDiff(currentImage, lastImage, output) {
  ...
  while (i < current.length / 4) {
    var average1 =
      (currentImage[4 * i] + currentImage[4 * i] + currentImage[4 * i + 2]) / 3
    var average2 =
      (lastImage[4 * i] + lastImage[4 * i] + lastImage[4 * i + 2]) / 3
...
//     var lastImageData;
//     var canvasSource = $("canvas")[0];
//     var canvasBlended = $("canvas")[0];
